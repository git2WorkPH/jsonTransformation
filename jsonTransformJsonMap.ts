...
export function JsonTransform2() {
...
const cacheMenu =  data //JSON.parse(fs.readFileSync('./jsonFile/Standard-BOH-V93(APP).json','utf8'))
console.log('input',cacheMenu)
const template = {
    categories:
    [{
        id: {
...
const finalResults = transform(cacheMenu,template)
console.log('final:',JSON.stringify(finalResults,null,3));

fs.writeFileSync('./output/menu2.json',JSON.stringify(finalResults,null,3))
}
